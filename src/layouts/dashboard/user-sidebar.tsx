...
//     ],
//   },
//   { title: "My Batch", url: "/user/batch", icon: Users },
//   { title: "Notifications", url: "/user/notifications", icon: Bell },
//   { title: "Privacy & Terms", url: "/privacy-policy", icon: Shield },
//   {
//     title: "Account",
//     url: "/user/account",
//     icon: Settings,
                          ...
                          return (
                            <SidebarMenuSubItem key={subItem.title}>
                              <SidebarMenuSubButton
                                ...
                                aria-disabled={subItem?.disabled}
                                className={cn(
                                  "w-full justify-start gap-3 rounded-lg px-3 py-2.5 text-sm transition-all duration-200 ml-2",
                                  isSubActive
